...
<h3 align="center">Software Engineer | Full Stack Developer from Nagpur, India</h3>
...
- 🚀 **NewsWave** — Full-stack news aggregation web app (Java, Spring Boot, Angular, MySQL) — sub-1s load times aggregating 5+ external sources with JWT-secured, real-time delivery
- 🔐 **DoloX** — Blockchain-based source code integrity platform (Python, Django, Solidity, Ethereum) — SHA-256 + smart-contract verification; findings published in IJRAR, Dec 2024
